# The Provider as a Spring Boot Application
## How to initialize a Spring Boot Application
We need to create a Gradle project, customized with the necessary Spring Boot dependencies. Spring Boot Initializr provides a user-friendly UI to do so.
