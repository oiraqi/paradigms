...
- [Kafka](https://kafka.apache.org/) - The De Facto Distributed ;Event Store and Stream Processing Platform
  - "Kafka was originally developed at LinkedIn, and was subsequently open sourced in early 2011. Jay Kreps, Neha Narkhede and Jun Rao helped co-create Kafka.[4] Graduation from the Apache Incubator occurred on 23 October 2012.[5] Jay Kreps chose to name the software after the author Franz Kafka because it is "a system optimized for writing", and he liked Kafka's work." - [Wikipedia](https://en.wikipedia.org/wiki/Apache_Kafka).
